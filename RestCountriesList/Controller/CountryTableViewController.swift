...
class CountryTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
       ...
       // infoItem()
        ...
        let myButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(greenColor))
        navigationItem.rightBarButtonItem = myButton
        
        let myButton2 = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(blackColor))
        navigationItem.leftBarButtonItem = myButton2
